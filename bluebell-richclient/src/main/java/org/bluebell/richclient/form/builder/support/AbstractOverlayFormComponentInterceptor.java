...
/**
 * Abstract form component interceptor useful for dealing with overlay installations.
 * 
...
public abstract class AbstractOverlayFormComponentInterceptor extends AbstractFormComponentInterceptor {
    ...
    public final OverlayService getOverlayService() {
        ...
        if (this.overlayService == null) {
            this.setOverlayService((OverlayService) Application.services().getService(OverlayService.class));
        }
